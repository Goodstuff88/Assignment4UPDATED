...
fluidRow(
  ...
  # column(width = 4,
  #        materialSwitch(inputId = "Top10Death",label =  "Top 10 death switch", status = "danger")),
  # 
  # column(width = 4,
  #       materialSwitch(inputId = "Top10Recov",label =  "Top 10 Recoveries switch", status = "danger"))
        ...
        sidebarLayout(
          sidebarPanel(
            ...
            prettyRadioButtons(inputId = "DataSelection",
                          ...
                          choiceNames = c("Cummalative cases", "Deaths", "Recoveries", "Infected"),
                          choiceValues = c("Cum_Confirmed", "Deaths", "Recovered", "Infected"),
...
if(input$DataSelection == "Cum_Confirmed") {
  

  Plot <- ggplot(data, aes(x = Date, y = Cum_Confirmed)) +
    geom_point(aes(color = Country_Region)) +
    labs(y = "Cummalative cases") +
    theme(legend.title = element_blank())
}
  
if(input$DataSelection == "Deaths") {
  Plot <- ggplot(data, aes(x = Date, y = Deaths)) +
    geom_point(aes(color = Country_Region)) +
    labs(y = "Deaths count") +
    theme(legend.title = element_blank())
}

if(input$DataSelection == "Recovered") {
  Plot <- ggplot(data, aes(x = Date, y = Recovered)) +
    geom_point(aes(color = Country_Region)) +
    labs(y = "Recovered count") +
    theme(legend.title = element_blank())
}
  
if(input$DataSelection == "Infected") {
  Plot <- ggplot(data, aes(x = Date, y = Deaths)) +
    geom_point(aes(color = Country_Region)) +
    labs(y = "Infected count") +
    theme(legend.title = element_blank())  
}
